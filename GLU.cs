...
//
		...
		public static extern Int32 gluNewQuadric ( );
		[DllImport(GLU_DLL, EntryPoint ="gluDeleteQuadric")]
        public static extern void gluDeleteQuadric(Int32 Quadric);
		[DllImport(GLU_DLL, EntryPoint ="gluQuadricNormals")]
        public static extern void gluQuadricNormals(Int32 Quadric, uint normals);
		[DllImport(GLU_DLL, EntryPoint ="gluQuadricTexture")]
        public static extern void gluQuadricTexture(Int32 Quadric, byte textureCoords);
		[DllImport(GLU_DLL, EntryPoint ="gluQuadricOrientation")]
        public static extern void gluQuadricOrientation(Int32 Quadric, uint orientation);
		[DllImport(GLU_DLL, EntryPoint ="gluQuadricDrawStyle")]
        public static extern void gluQuadricDrawStyle(Int32 Quadric, uint drawStyle);
		[DllImport(GLU_DLL, EntryPoint ="gluCylinder")]
        public static extern void gluCylinder(Int32 Quadric, double baseRadius, double topRadius, double height, int slices, int stacks);
		[DllImport(GLU_DLL, EntryPoint ="gluDisk")]
        public static extern void gluDisk(Int32 Quadric, double innerRadius, double outerRadius, int slices, int loops);
		[DllImport(GLU_DLL, EntryPoint ="gluPartialDisk")]
        public static extern void gluPartialDisk(Int32 Quadric, double innerRadius, double outerRadius, int slices, int loops, double startAngle, double sweepAngle);
		[DllImport(GLU_DLL, EntryPoint ="gluSphere")]
        public static extern void gluSphere(Int32 Quadric, double radius, int slices, int stacks);
		[DllImport(GLU_DLL, EntryPoint ="gluQuadricCallback")]
        public static extern void gluQuadricCallback(Int32 Quadric, uint which, IntPtr fn);
//
